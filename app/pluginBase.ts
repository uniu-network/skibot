...
type LegacyFieldDecorator = (
  target: object,
  propertyKey: string | symbol,
) => void;
type StandardFieldDecorator = <T, V>(
  value: undefined,
  context: ClassFieldDecoratorContext<T, V>,
) => void;

export function ConfigField(
  def: Omit<ConfigFieldDefinition, "propertyKey">,
): LegacyFieldDecorator & StandardFieldDecorator {
  return function (
    ...
    registerConfigField(
      (targetOrValue as object).constructor,
